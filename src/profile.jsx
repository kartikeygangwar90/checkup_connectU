...
//             <div className="card1">
//                 <h4 id='fhname'>First Name : </h4>
//                 <input type="text" value={userData.firstName} placeholder='First name here' id='fname' onChange={(e) =>
//                     setUserData({ ...userData, firstName: e.target.value })
//                 }
//                 />
//                 <h4 id='lhname'>Last Name : </h4>
//                 <input type="text" id="lname" placeholder='Last name here' value={userData.lastName} onChange={(e) =>
//                     setUserData({ ...userData, lastName: e.target.value })
//                 } />
//                 <h4 id='gender'>Gender : </h4>
//                 <input type="radio" name="gender" id="male-inp" className='male' value="Male" checked={userData.gender === "Male"} onChange={(e) =>
//                     setUserData({ ...userData, gender: e.target.value })
//                 }></input><h4 className='male' id='Male'>Male</h4>
//                 <input type="radio" name="gender" id="female-inp" className='female' value="Female" checked={userData.gender === "Female"} onChange={(e) =>
//                     setUserData({ ...userData, gender: e.target.value })
//                 } /><h4 className='female' id='Female'>Female</h4>
//                 <input type="radio" name="gender" id="other-inp" className='other' value="Other" checked={userData.gender === "Other"} onChange={(e) =>
//                     setUserData({ ...userData, gender: e.target.value })
//                 } /><h4 className='other' id='Other'>Other</h4>
//                 <h4 id='roll-head'>Roll number : </h4>
//                 <input type="text" inputMode='numeric' pattern='[0-9]' id="roll" placeholder='Enter Roll number ' value={userData.roll} onChange={(e) =>
    ...
    return (
        <main>
            <div className="complete--page">
                <h2 id="page--heading">Create Your Profile</h2>
                ...
                {step === 1 && <div className="info--section block">
                    ...
                    />
                    <h5 id="email--heading">Email Address <span className="required">*</span></h5>
                    <input
                        type="text"
                        id="email--input"
                    ...
                    />
                    <h5 id="college--input">University <span className="required">*</span></h5>
                    <select
                        id='options--college'
                        ...
                        <option value="NITP" id='college-selection'>national Institute of Technology Patna</option>
                    </select>
                    <h5>Year <span className="required">*</span></h5>
                    <select id="options--year" value={userData.year} onChange={(e) =>
                    ...
                    <select id='options--branch' value={userData.branch} onChange={(e) =>
